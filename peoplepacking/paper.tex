...
This measures how efficiently the pose fills its own bounding box. A cube achieves $\eta_{\text{BB}} = 1.0$; our best human pose achieves $\eta_{\text{BB}} = 0.55$.
...
\midrule
Star / Spread Eagle & 0.510 & 54.9\% & 1.61 \\
Standing (arms at sides) & 0.222 & 48.1\% & 1.42 \\
Planking / Coffin Dance & 0.222 & 48.1\% & 1.42 \\
Superman (arms up) & 0.251 & 48.3\% & 1.42 \\
Da Vinci Vitruvian & 0.617 & 45.5\% & 1.34 \\
Downward Dog & 0.669 & 40.4\% & 1.19 \\
John Travolta Disco & 0.531 & 39.8\% & 1.17 \\
A-Pose (Game Dev) & 0.516 & 34.5\% & 1.02 \\
T-Pose & 0.642 & 34.0\% & 1.00 \\
Pike (folded) & 0.630 & 33.6\% & 0.99 \\
Dab & 0.660 & 32.0\% & 0.94 \\
Squat (Slav) & 0.544 & 30.7\% & 0.90 \\
Fetal Position & 0.646 & 27.5\% & 0.81 \\
Titanic (Jack \& Rose) & 1.019 & 24.4\% & 0.72 \\
Heisman Trophy & 1.606 & 22.8\% & 0.67 \\
Usain Bolt Lightning & 1.525 & 21.2\% & 0.62 \\
\bottomrule
\end{tabular}
...
\midrule
Elevator (7.2~m$^3$) & \textbf{21} & 9 & 9 & 8 & 4 & 12 \\
Phone Booth (1.9~m$^3$) & \textbf{4} & 2 & 0 & 0 & 0 & 1 \\
Container (33.1~m$^3$) & \textbf{108} & 66 & 36 & 32 & 18 & --- \\
Minivan (3.9~m$^3$) & \textbf{12} & 4 & 5 & 5 & 2 & 7 \\
Boeing 737 (218~m$^3$) & \textbf{952} & 420 & 304 & 280 & 170 & 189 \\
Subway Car (81~m$^3$) & \textbf{324} & 126 & 90 & 112 & 54 & $\sim$150 \\
School Bus (30~m$^3$) & \textbf{120} & 54 & 40 & 35 & 20 & 72 \\
Hot Tub (4.0~m$^3$) & \textbf{12} & 4 & 3 & 3 & 2 & 6 \\
\bottomrule
\end{tabular}
...
\caption{3D packing visualizations. Top: an elevator packed with 21 humans in Standing pose (left) vs.\ 9 in Fetal position (right). Bottom: a shipping container with 108 Standing (left) vs.\ 75 Squatting (right). Note that the rotation-search optimizer may orient ``standing'' humans non-upright to maximize count. Colors distinguish individual bodies.}
\label{fig:scenes}
\end{figure}

\subsection{The 2D Paradox}

An interesting divergence emerges between 2D intuition and 3D reality. When viewed as a 2D silhouette, the Pike (folded) and Fetal poses appear compact---they minimize the projected area visible from the front. However, in 3D, folding the body \emph{increases} depth along the $y$-axis, inflating the bounding-box volume. The Fetal position has a near-cubic BB of $0.96 \times 0.78 \times 0.87$~m, yielding a volume 2.9$\times$ larger than Standing. This ``2D Paradox'' illustrates the danger of reducing a fundamentally 3D problem to 2D projections---a mistake made by approximately 100\% of prior elevator capacity analyses.
...
Even accounting for the fact that passengers are typically seated (Thinking Man pose: 400), airlines leave 52.7\% of theoretical capacity unused. We leave the ethical implications of this observation as an exercise for the reader.
...
We have demonstrated, through rigorous computational analysis, that the optimal way to pack human beings is the way everyone already suspected: standing up straight with your arms at your sides, like sardines. The T-Pose wastes $2.9\times$ the bounding-box volume. The Dab wastes $3.0\times$. The Heisman Trophy wastes $7.2\times$.

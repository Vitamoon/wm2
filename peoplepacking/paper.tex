...
All preceding results assume an average adult male (1.75~m, BMI~25). Real populations exhibit substantial morphological diversity. We re-run the shipping container packing analysis with the human rig scaled to simulate different body types (Table~\ref{tab:diversity}).
